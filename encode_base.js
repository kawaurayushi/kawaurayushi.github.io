...
function check_default(){
  init();
  $( ".step1" ).html('Step 0 :  code check ...<br>');
  ...
  $( ".step1" ).append('Step 1 :  ROT(+-)/Reverse/Atbash start ...<br>');
...
//     original=braille;
     ...
     $( ".step1" ).append('Not Braille ' +str+'<br>' );
  }
...
//  var text = $( ".inputvalue" ).val().toLowerCase().trim();
  ...
  if(mode =="Normal"){
     ...
     $( '<li> Morse XR-> ' +decoded_string_at2+'</li>' ).appendTo($( ".step1" ));
  }
  checkprint(mode+"/Morse R               : ", decoded_string_at);
  checkprint(mode+"/Morse XR              : ", decoded_string_at2);
  code_exchange(decoded_string_at);
  ...
  if(str2 != decoded_string_at2)    checkprint(mode+"/Morse XR NUM          : ", str2);
  ...
  checkprint(mode+"/Morse XR/R : ", decoded_string_at2);
  code_exchange(decoded_string_at);
  code_exchange(decoded_string_at2);

  if(mode =="Normal"){
     $( '<li> Morse R/R-> ' +decoded_string_at+'</li>' ).appendTo($( ".step1" ));
     $( '<li> Morse XR/R-> ' +decoded_string_at2+'</li>' ).appendTo($( ".step1" ));
  }
